...
<div class="card card-default">
    <table>
        <tr>
            <td><a href="{{ url('tambah-pembelian') }}" class="btn btn-primary">Tambah Invoice Pembelian</a></td>

            <td class="col-2">&nbsp;</td>
             <td>
                <span class="font-weight-bold">Tanggal</span>
                <select name="" id="ContentPlaceHolder1_DropDownList1" class="form-control">
            ...
            <td>
                <span id="ContentPlaceHolder1_Label4" class="font-weight-bold">Status Invoice</span>
                <select name="ctl00$ContentPlaceHolder1$ddlStatusInvoice" id="ContentPlaceHolder1_ddlStatusInvoice" class="form-control">
                    <option value=""></option>
                    <option value="">-------------------</option>
    ...
    <table class="mb-0 table">
        <thead>
            <tr style="background-color:white">
                ...
                <th id="ContentPlaceHolder1_thVal" colspan="3">Action</th>            
            </tr>
        </thead>
        <tbody>
            @foreach ($pembelian as $keys=>$value)
            <td>{{ $value->id_popembelianmst }}</td>
            <td>{{ $value->suppliernama }}</td>
            <td>{{ $value->tanggalpopembelian }}</td>
            <td>{{ $value->tanggalpojatuhtmppembelian }}</td>
            <td>{{ $value->jenistagihan }}</td>
            <td>{{ $value->totaltagihanpembelian }}</td>
            <td>{{ $value->gudangnama }}</td>
            <td>{{ $value->statusinvoicepembelianmst }}</td>
            <td></td>
            @endforeach
